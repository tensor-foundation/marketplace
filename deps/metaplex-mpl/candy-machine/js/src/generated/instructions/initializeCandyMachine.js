...
function createInitializeCandyMachineInstruction(accounts, args, programId = new web3.PublicKey('cndy3Z4yapfJBmL3ShUp5exZKqR3z33thTzeNMm2gRZ')) {
    var _a, _b;
    const [data] = exports.initializeCandyMachineStruct.serialize(Object.assign({ instructionDiscriminator: exports.initializeCandyMachineInstructionDiscriminator }, args));
    const keys = [
        {
