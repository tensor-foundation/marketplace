 ...
 * @category generated
 */
exports.setFreezeStruct = new beet.BeetArgsStruct([
...
function createSetFreezeInstruction(accounts, args, programId = new web3.PublicKey('cndy3Z4yapfJBmL3ShUp5exZKqR3z33thTzeNMm2gRZ')) {
    var _a;
    const [data] = exports.setFreezeStruct.serialize(Object.assign({ instructionDiscriminator: exports.setFreezeInstructionDiscriminator }, args));
    const keys = [
        {
