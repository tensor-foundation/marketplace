...
function createWithdrawInstruction(accounts, args) {
    const { auctionHouseProgram, wallet, receiptAccount, escrowPaymentAccount, treasuryMint, authority, auctionHouse, auctionHouseFeeAccount, auctioneerAuthority, ahAuctioneerPda, } = accounts;
