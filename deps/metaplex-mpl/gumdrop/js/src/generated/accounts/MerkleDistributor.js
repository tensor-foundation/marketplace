...
exports.merkleDistributorBeet = exports.MerkleDistributor = void 0;
...
class MerkleDistributor {
    constructor(base, bump, root /* size: 32 */, temporal) {
        this.base = base;
        this.bump = bump;
        this.root = root;
    ...
    static deserialize(buf, offset = 0) {
        return exports.merkleDistributorBeet.deserialize(buf, offset);
    }
    /**
     ...
     */
    serialize() {
        return exports.merkleDistributorBeet.serialize(Object.assign({ accountDiscriminator: merkleDistributorDiscriminator }, this));
    }
    /**
     ...
     */
    static get byteSize() {
        return exports.merkleDistributorBeet.byteSize;
    }
    /**
 ...
 * @category generated
 */
exports.merkleDistributorBeet = new beet.BeetStruct([
    ['accountDiscriminator', beet.uniformFixedSizeArray(beet.u8, 8)],
    ['base', beetSolana.publicKey],
    ['bump', beet.u8],
    ['root', beet.uniformFixedSizeArray(beet.u8, 32)],
    ['temporal', beetSolana.publicKey],
], MerkleDistributor.fromArgs, 'MerkleDistributor');
