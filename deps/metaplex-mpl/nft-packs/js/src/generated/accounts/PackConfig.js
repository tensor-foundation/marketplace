...
exports.packConfigBeet = exports.PackConfig = void 0;
const beet = __importStar(require("@metaplex-foundation/beet"));
const web3 = __importStar(require("@solana/web3.js"));
const beetSolana = __importStar(require("@metaplex-foundation/beet-solana"));
const AccountType_1 = require("../types/AccountType");
const CleanUpActions_1 = require("../types/CleanUpActions");
/**
 ...
 */
class PackConfig {
    constructor(accountType, weights, actionToDo) {
    ...
    static gpaBuilder(programId = new web3.PublicKey('packFeFNZzMfD9aVWL7QbGz1WcU7R9zpf6pvNsw2BLu')) {
        return beetSolana.GpaBuilder.fromStruct(programId, exports.packConfigBeet);
    }
    /**
    ...
    static deserialize(buf, offset = 0) {
        return exports.packConfigBeet.deserialize(buf, offset);
    }
    /**
     ...
     */
    serialize() {
        return exports.packConfigBeet.serialize(this);
    }
    /**
    ...
    static byteSize(args) {
        ...
        return exports.packConfigBeet.toFixedFromValue(instance).byteSize;
    }
    /**
 ...
 * @category generated
 */
exports.packConfigBeet = new beet.FixableBeetStruct([
    ['accountType', AccountType_1.accountTypeBeet],
    ['weights', beet.array(beet.fixedSizeTuple([beet.u32, beet.u32, beet.u32]))],
    ['actionToDo', CleanUpActions_1.cleanUpActionsBeet],
], PackConfig.fromArgs, 'PackConfig');
