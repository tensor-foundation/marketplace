...
function signAllMetadataFromCandyMachine(connection, wallet, candyMachineAddress, batchSize, daemon) {
    return __awaiter(this, void 0, void 0, function* () {
        if (daemon) {
            ...
            for (;;) {
                yield findAndSignMetadata(candyMachineAddress, connection, wallet, batchSize);
...
function findAndSignMetadata(candyMachineAddress, connection, wallet, batchSize) {
    return __awaiter(this, void 0, void 0, function* () {
        const metadataByCandyMachine = yield getAccountsByCreatorAddress(candyMachineAddress, connection);
        ...
        const candyVerifiedListToSign = yield getCandyMachineVerifiedMetadata(metadataByCandyMachine, candyMachineAddress, wallet.publicKey.toBase58());
        loglevel_1.default.info(`Found ${candyVerifiedListToSign.length} nft's to sign by  ${wallet.publicKey.toBase58()}`);
        yield sendSignMetadata(connection, wallet, candyVerifiedListToSign, batchSize);
    });
}
function getAccountsByCreatorAddress(creatorAddress, connection) {
    return __awaiter(this, void 0, void 0, function* () {
        const metadataAccounts = yield getProgramAccounts(connection, constants_1.TOKEN_METADATA_PROGRAM_ID.toBase58(), {
            filters: [
                {
                    memcmp: {
                        offset: 1 + // key
        ...
        for (let i = 0; i < metadataAccounts.length; i++) {
            ...
            const decoded = yield decodeMetadata(e.account.data);
...
function getAddressesByCreatorAddress(candyMachineAddr, connection) {
    return __awaiter(this, void 0, void 0, function* () {
        const accountsByCreatorAddress = yield getAccountsByCreatorAddress(candyMachineAddr, connection);
...
function sendSignMetadata(connection, wallet, metadataList, batchsize) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (metadataList.length > 0) {
            ...
            total += sliceAmount;
            yield delay(500);
            yield signMetadataBatch(removed, connection, wallet);
