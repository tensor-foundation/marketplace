...
function upload(data, manifest, index) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield (yield (0, node_fetch_1.default)(ARWEAVE_UPLOAD_ENDPOINT, {
            method: 'POST',
            // @ts-ignore
            body: data,
        })).json();
...
index) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const fsStat = yield (0, promises_1.stat)(image);
        const estimatedManifestSize = estimateManifestSize([
            `${index}${imageExt}`,
            'metadata.json',
        ]);
        const storageCost = yield fetchAssetCostToStore([
            fsStat.size,
