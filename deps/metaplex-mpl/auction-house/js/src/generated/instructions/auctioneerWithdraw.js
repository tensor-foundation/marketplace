 ...
 * @category generated
 */
exports.auctioneerWithdrawStruct = new beet.BeetArgsStruct([
 ...
 * @category generated
 */
function createAuctioneerWithdrawInstruction(accounts, args, programId = new web3.PublicKey('hausS13jsjafwWwGqZTUQRmWyvyxn9EQpqMwV1PBBmk')) {
    var _a, _b, _c, _d;
    const [data] = exports.auctioneerWithdrawStruct.serialize(Object.assign({ instructionDiscriminator: exports.auctioneerWithdrawInstructionDiscriminator }, args));
    const keys = [
        {
...
exports.createAuctioneerWithdrawInstruction = createAuctioneerWithdrawInstruction;
