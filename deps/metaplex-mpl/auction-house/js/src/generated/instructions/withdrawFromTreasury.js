 ...
 * @category generated
 */
exports.withdrawFromTreasuryStruct = new beet.BeetArgsStruct([
 ...
 * @category generated
 */
function createWithdrawFromTreasuryInstruction(accounts, args, programId = new web3.PublicKey('hausS13jsjafwWwGqZTUQRmWyvyxn9EQpqMwV1PBBmk')) {
    var _a, _b;
    const [data] = exports.withdrawFromTreasuryStruct.serialize(Object.assign({ instructionDiscriminator: exports.withdrawFromTreasuryInstructionDiscriminator }, args));
    const keys = [
        {
...
exports.createWithdrawFromTreasuryInstruction = createWithdrawFromTreasuryInstruction;
