 ...
 * @category generated
 */
exports.auctioneerSellStruct = new beet.BeetArgsStruct([
 ...
 * @category generated
 */
function createAuctioneerSellInstruction(accounts, args, programId = new web3.PublicKey('hausS13jsjafwWwGqZTUQRmWyvyxn9EQpqMwV1PBBmk')) {
    var _a, _b, _c;
    const [data] = exports.auctioneerSellStruct.serialize(Object.assign({ instructionDiscriminator: exports.auctioneerSellInstructionDiscriminator }, args));
    const keys = [
        {
...
exports.createAuctioneerSellInstruction = createAuctioneerSellInstruction;
