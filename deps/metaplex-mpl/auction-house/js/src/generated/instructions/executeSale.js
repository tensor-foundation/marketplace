 ...
 * @category generated
 */
exports.executeSaleStruct = new beet.BeetArgsStruct([
 ...
 * @category generated
 */
function createExecuteSaleInstruction(accounts, args, programId = new web3.PublicKey('hausS13jsjafwWwGqZTUQRmWyvyxn9EQpqMwV1PBBmk')) {
    var _a, _b, _c, _d;
    const [data] = exports.executeSaleStruct.serialize(Object.assign({ instructionDiscriminator: exports.executeSaleInstructionDiscriminator }, args));
    const keys = [
        {
