 ...
 * @category generated
 */
exports.auctioneerBuyStruct = new beet.BeetArgsStruct([
 ...
 * @category generated
 */
function createAuctioneerBuyInstruction(accounts, args, programId = new web3.PublicKey('hausS13jsjafwWwGqZTUQRmWyvyxn9EQpqMwV1PBBmk')) {
    var _a, _b, _c;
    const [data] = exports.auctioneerBuyStruct.serialize(Object.assign({ instructionDiscriminator: exports.auctioneerBuyInstructionDiscriminator }, args));
    const keys = [
        {
...
exports.createAuctioneerBuyInstruction = createAuctioneerBuyInstruction;
