 ...
 * @category generated
 */
exports.auctioneerCancelStruct = new beet.BeetArgsStruct([
 ...
 * @category generated
 */
function createAuctioneerCancelInstruction(accounts, args, programId = new web3.PublicKey('hausS13jsjafwWwGqZTUQRmWyvyxn9EQpqMwV1PBBmk')) {
    var _a;
    const [data] = exports.auctioneerCancelStruct.serialize(Object.assign({ instructionDiscriminator: exports.auctioneerCancelInstructionDiscriminator }, args));
    const keys = [
        {
...
exports.createAuctioneerCancelInstruction = createAuctioneerCancelInstruction;
