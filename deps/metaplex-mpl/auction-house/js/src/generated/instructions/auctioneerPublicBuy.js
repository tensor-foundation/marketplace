...
function createAuctioneerPublicBuyInstruction(accounts, args, programId = new web3.PublicKey('hausS13jsjafwWwGqZTUQRmWyvyxn9EQpqMwV1PBBmk')) {
    var _a, _b, _c;
    const [data] = exports.auctioneerPublicBuyStruct.serialize(Object.assign({ instructionDiscriminator: exports.auctioneerPublicBuyInstructionDiscriminator }, args));
    const keys = [
        {
