 ...
 * @category generated
 */
exports.auctioneerDepositStruct = new beet.BeetArgsStruct([
 ...
 * @category generated
 */
function createAuctioneerDepositInstruction(accounts, args, programId = new web3.PublicKey('hausS13jsjafwWwGqZTUQRmWyvyxn9EQpqMwV1PBBmk')) {
    var _a, _b, _c;
    const [data] = exports.auctioneerDepositStruct.serialize(Object.assign({ instructionDiscriminator: exports.auctioneerDepositInstructionDiscriminator }, args));
    const keys = [
        {
...
exports.createAuctioneerDepositInstruction = createAuctioneerDepositInstruction;
