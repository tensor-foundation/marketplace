...
function createCreateMetadataAccountV2Instruction(accounts, args, programId = new web3.PublicKey('metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s')) {
    var _a;
    const [data] = exports.CreateMetadataAccountV2Struct.serialize(Object.assign({ instructionDiscriminator: exports.createMetadataAccountV2InstructionDiscriminator }, args));
    const keys = [
        {
