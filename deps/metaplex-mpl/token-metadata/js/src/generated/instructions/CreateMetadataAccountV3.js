...
function createCreateMetadataAccountV3Instruction(accounts, args, programId = new web3.PublicKey('metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s')) {
    var _a;
    const [data] = exports.CreateMetadataAccountV3Struct.serialize(Object.assign({ instructionDiscriminator: exports.createMetadataAccountV3InstructionDiscriminator }, args));
    const keys = [
        {
