...
const UseArgs_1 = require("../types/UseArgs");
/**
...
function createUseInstruction(accounts, args, programId = new web3.PublicKey('metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s')) {
    ...
    const [data] = exports.UseStruct.serialize(Object.assign({ instructionDiscriminator: exports.useInstructionDiscriminator }, args));
    const keys = [
        {
