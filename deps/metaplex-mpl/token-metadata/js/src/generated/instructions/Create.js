...
const CreateArgs_1 = require("../types/CreateArgs");
/**
...
function createCreateInstruction(accounts, args, programId = new web3.PublicKey('metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s')) {
    var _a, _b;
    const [data] = exports.CreateStruct.serialize(Object.assign({ instructionDiscriminator: exports.createInstructionDiscriminator }, args));
    const keys = [
        {
