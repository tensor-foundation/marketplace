...
const LockArgs_1 = require("../types/LockArgs");
/**
...
function createLockInstruction(accounts, args, programId = new web3.PublicKey('metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s')) {
    ...
    const [data] = exports.LockStruct.serialize(Object.assign({ instructionDiscriminator: exports.lockInstructionDiscriminator }, args));
    const keys = [
        {
