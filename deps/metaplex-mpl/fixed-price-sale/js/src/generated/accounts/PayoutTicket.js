...
exports.payoutTicketBeet = exports.PayoutTicket = exports.payoutTicketDiscriminator = void 0;
const beet = __importStar(require("@metaplex-foundation/beet"));
const web3 = __importStar(require("@solana/web3.js"));
const beetSolana = __importStar(require("@metaplex-foundation/beet-solana"));
exports.payoutTicketDiscriminator = [153, 222, 52, 216, 192, 152, 175, 80];
/**
...
class PayoutTicket {
    ...
    static gpaBuilder(programId = new web3.PublicKey('SaLeTjyUa5wXHnGuewUSyJ5JWZaHwz3TxqUntCE9czo')) {
        return beetSolana.GpaBuilder.fromStruct(programId, exports.payoutTicketBeet);
    }
    /**
    ...
    static deserialize(buf, offset = 0) {
        return exports.payoutTicketBeet.deserialize(buf, offset);
    }
    /**
     ...
     */
    serialize() {
        return exports.payoutTicketBeet.serialize(Object.assign({ accountDiscriminator: exports.payoutTicketDiscriminator }, this));
    }
    /**
     ...
     */
    static get byteSize() {
        return exports.payoutTicketBeet.byteSize;
    }
    /**
 ...
 * @category generated
 */
exports.payoutTicketBeet = new beet.BeetStruct([
    ['accountDiscriminator', beet.uniformFixedSizeArray(beet.u8, 8)],
    ['used', beet.bool],
], PayoutTicket.fromArgs, 'PayoutTicket');
