...
impl DelistLegacy {
    pub fn instruction(
        &self,
        args: DelistLegacyInstructionArgs,
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = DelistLegacyInstructionData::new().try_to_vec().unwrap();
...
pub struct DelistLegacyInstructionData {
    discriminator: [u8; 8],
}

impl DelistLegacyInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for DelistLegacyInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct DelistLegacyInstructionArgs {
    pub authorization_data: Option<AuthorizationDataLocal>,
}

/// Instruction builder for `DelistLegacy`.
///
/// ### Accounts:
///
...
pub struct DelistLegacyBuilder {
...
impl DelistLegacyBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = DelistLegacyInstructionArgs {
...
/// `delist_legacy` CPI accounts.
pub struct DelistLegacyCpiAccounts<'a, 'b> {
...
/// `delist_legacy` CPI instruction.
pub struct DelistLegacyCpi<'a, 'b> {
    ...
    pub __args: DelistLegacyInstructionArgs,
}

impl<'a, 'b> DelistLegacyCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: DelistLegacyCpiAccounts<'a, 'b>,
        args: DelistLegacyInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `DelistLegacy` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` owner
...
///   18. `[optional]` sysvar_instructions
#[derive(Clone, Debug)]
pub struct DelistLegacyCpiBuilder<'a, 'b> {
    instruction: Box<DelistLegacyCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> DelistLegacyCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(DelistLegacyCpiBuilderInstruction {
            __program: program,
            owner: None,
            owner_ta: None,
            list_state: None,
    ...
    pub fn invoke_signed(
        ...
        let instruction = DelistLegacyCpi {
...
#[derive(Clone, Debug)]
struct DelistLegacyCpiBuilderInstruction<'a, 'b> {
