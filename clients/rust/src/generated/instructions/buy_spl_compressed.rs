...
///   9. `[optional]` currency_token_program (default to `TokenkegQfeZyiNwAJbNbGKPFXCWuBvf9Ss623VQ5DA`)
///   10. `[optional]` associated_token_program (default to `ATokenGPvbdGVxr1b2hvZbsiqW5xWH25efTNsLJA8knL`)
///   11. `[writable]` list_state
///   12. `[]` buyer
///   13. `[signer]` payer
///   14. `[writable]` payer_currency_ta
///   15. `[]` owner
///   16. `[writable]` owner_currency_ta
///   17. `[]` currency
