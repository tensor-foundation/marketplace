...
This is a quick guide to help you contribute to the JavaScript client of Marketplace.
...
- `VERCEL_PROJECT_ID` — The ID of the Vercel project you want to deploy to.
  The convention is to create a new Vercel project named `marketplace-js-docs` with the following deployment settings:
