...
export const BUY_T22_SPL_DISCRIMINATOR = new Uint8Array([
  102, 21, 163, 39, 94, 39, 122, 94,
]);

export function getBuyT22SplDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(BUY_T22_SPL_DISCRIMINATOR);
}
...
export function getBuyT22SplInstructionDataEncoder(): Encoder<BuyT22SplInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: BUY_T22_SPL_DISCRIMINATOR })
  );
}
