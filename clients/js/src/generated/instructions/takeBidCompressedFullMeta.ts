...
export const TAKE_BID_COMPRESSED_FULL_META_DISCRIMINATOR = new Uint8Array([
  242, 194, 203, 225, 234, 53, 10, 96,
]);

export function getTakeBidCompressedFullMetaDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    TAKE_BID_COMPRESSED_FULL_META_DISCRIMINATOR
  );
}
...
export function getTakeBidCompressedFullMetaInstructionDataEncoder(): Encoder<TakeBidCompressedFullMetaInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: TAKE_BID_COMPRESSED_FULL_META_DISCRIMINATOR,
