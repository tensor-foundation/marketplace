...
export const TAKE_BID_T22_DISCRIMINATOR = new Uint8Array([
  18, 250, 113, 242, 31, 244, 19, 150,
]);

export function getTakeBidT22DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    TAKE_BID_T22_DISCRIMINATOR
  );
}
...
export function getTakeBidT22InstructionDataEncoder(): Encoder<TakeBidT22InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: TAKE_BID_T22_DISCRIMINATOR })
  );
}
