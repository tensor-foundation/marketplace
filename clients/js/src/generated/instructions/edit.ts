...
export const EDIT_DISCRIMINATOR = new Uint8Array([
  15, 183, 33, 86, 87, 28, 151, 145,
]);

export function getEditDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(EDIT_DISCRIMINATOR);
}
...
export function getEditInstructionDataEncoder(): Encoder<EditInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: EDIT_DISCRIMINATOR,
