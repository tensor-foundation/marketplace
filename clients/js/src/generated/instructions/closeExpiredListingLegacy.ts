...
export const CLOSE_EXPIRED_LISTING_LEGACY_DISCRIMINATOR = new Uint8Array([
  56, 16, 96, 188, 55, 68, 250, 58,
]);

export function getCloseExpiredListingLegacyDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    CLOSE_EXPIRED_LISTING_LEGACY_DISCRIMINATOR
  );
}
...
export function getCloseExpiredListingLegacyInstructionDataEncoder(): Encoder<CloseExpiredListingLegacyInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: CLOSE_EXPIRED_LISTING_LEGACY_DISCRIMINATOR,
