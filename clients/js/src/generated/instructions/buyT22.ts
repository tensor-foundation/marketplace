...
export const BUY_T22_DISCRIMINATOR = new Uint8Array([
  81, 98, 227, 171, 201, 105, 180, 216,
]);

export function getBuyT22DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(BUY_T22_DISCRIMINATOR);
}
...
export function getBuyT22InstructionDataEncoder(): Encoder<BuyT22InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: BUY_T22_DISCRIMINATOR })
  );
}
