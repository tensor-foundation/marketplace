...
export const LIST_COMPRESSED_DISCRIMINATOR = new Uint8Array([
  54, 174, 193, 67, 17, 41, 132, 38,
]);

export function getListCompressedDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    LIST_COMPRESSED_DISCRIMINATOR
  );
}
...
export function getListCompressedInstructionDataEncoder(): Encoder<ListCompressedInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: LIST_COMPRESSED_DISCRIMINATOR,
