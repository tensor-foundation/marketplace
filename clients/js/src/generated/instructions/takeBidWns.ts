...
export const TAKE_BID_WNS_DISCRIMINATOR = new Uint8Array([
  88, 5, 122, 88, 250, 139, 35, 216,
]);

export function getTakeBidWnsDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    TAKE_BID_WNS_DISCRIMINATOR
  );
}
...
export function getTakeBidWnsInstructionDataEncoder(): Encoder<TakeBidWnsInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: TAKE_BID_WNS_DISCRIMINATOR })
  );
}
