...
export const DELIST_LEGACY_DISCRIMINATOR = new Uint8Array([
  88, 35, 231, 184, 110, 218, 149, 23,
]);

export function getDelistLegacyDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    DELIST_LEGACY_DISCRIMINATOR
  );
}
...
export function getDelistLegacyInstructionDataEncoder(): Encoder<DelistLegacyInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: DELIST_LEGACY_DISCRIMINATOR,
