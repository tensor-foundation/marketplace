...
export const DELIST_COMPRESSED_DISCRIMINATOR = new Uint8Array([
  55, 136, 205, 107, 107, 173, 4, 31,
]);

export function getDelistCompressedDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    DELIST_COMPRESSED_DISCRIMINATOR
  );
}
...
export function getDelistCompressedInstructionDataEncoder(): Encoder<DelistCompressedInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: DELIST_COMPRESSED_DISCRIMINATOR })
  );
}
