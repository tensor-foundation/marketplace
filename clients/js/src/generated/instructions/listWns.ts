...
export const LIST_WNS_DISCRIMINATOR = new Uint8Array([
  23, 202, 102, 138, 255, 190, 39, 196,
]);

export function getListWnsDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(LIST_WNS_DISCRIMINATOR);
}
...
export function getListWnsInstructionDataEncoder(): Encoder<ListWnsInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: LIST_WNS_DISCRIMINATOR,
