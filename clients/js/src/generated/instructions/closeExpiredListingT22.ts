...
export const CLOSE_EXPIRED_LISTING_T22_DISCRIMINATOR = new Uint8Array([
  69, 2, 190, 122, 144, 119, 122, 220,
]);

export function getCloseExpiredListingT22DiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    CLOSE_EXPIRED_LISTING_T22_DISCRIMINATOR
  );
}
...
export function getCloseExpiredListingT22InstructionDataEncoder(): Encoder<CloseExpiredListingT22InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: CLOSE_EXPIRED_LISTING_T22_DISCRIMINATOR,
    })
  );
}
