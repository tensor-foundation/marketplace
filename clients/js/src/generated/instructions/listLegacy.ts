...
export const LIST_LEGACY_DISCRIMINATOR = new Uint8Array([
  6, 110, 255, 18, 16, 36, 8, 30,
]);

export function getListLegacyDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(LIST_LEGACY_DISCRIMINATOR);
}
...
export function getListLegacyInstructionDataEncoder(): Encoder<ListLegacyInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: LIST_LEGACY_DISCRIMINATOR,
