...
export const BUY_WNS_SPL_DISCRIMINATOR = new Uint8Array([
  113, 137, 57, 23, 186, 196, 217, 210,
]);

export function getBuyWnsSplDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(BUY_WNS_SPL_DISCRIMINATOR);
}
...
export function getBuyWnsSplInstructionDataEncoder(): Encoder<BuyWnsSplInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: BUY_WNS_SPL_DISCRIMINATOR })
  );
}
