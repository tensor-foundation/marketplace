...
export const DELIST_WNS_DISCRIMINATOR = new Uint8Array([
  172, 171, 57, 16, 74, 158, 32, 57,
]);

export function getDelistWnsDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(DELIST_WNS_DISCRIMINATOR);
}
...
export function getDelistWnsInstructionDataEncoder(): Encoder<DelistWnsInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: DELIST_WNS_DISCRIMINATOR })
  );
}
