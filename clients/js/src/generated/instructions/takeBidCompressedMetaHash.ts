...
export const TAKE_BID_COMPRESSED_META_HASH_DISCRIMINATOR = new Uint8Array([
  85, 227, 202, 70, 45, 215, 10, 193,
]);

export function getTakeBidCompressedMetaHashDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    TAKE_BID_COMPRESSED_META_HASH_DISCRIMINATOR
  );
}
...
export function getTakeBidCompressedMetaHashInstructionDataEncoder(): Encoder<TakeBidCompressedMetaHashInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: TAKE_BID_COMPRESSED_META_HASH_DISCRIMINATOR,
