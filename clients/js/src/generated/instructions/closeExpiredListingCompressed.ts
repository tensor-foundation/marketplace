...
export const CLOSE_EXPIRED_LISTING_COMPRESSED_DISCRIMINATOR = new Uint8Array([
  150, 70, 13, 135, 9, 204, 75, 4,
]);

export function getCloseExpiredListingCompressedDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    CLOSE_EXPIRED_LISTING_COMPRESSED_DISCRIMINATOR
  );
}
...
export function getCloseExpiredListingCompressedInstructionDataEncoder(): Encoder<CloseExpiredListingCompressedInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: CLOSE_EXPIRED_LISTING_COMPRESSED_DISCRIMINATOR,
    })
  );
}
