...
export const BUY_CORE_SPL_DISCRIMINATOR = new Uint8Array([
  234, 28, 37, 122, 114, 239, 233, 208,
]);

export function getBuyCoreSplDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    BUY_CORE_SPL_DISCRIMINATOR
  );
}
...
export function getBuyCoreSplInstructionDataEncoder(): Encoder<BuyCoreSplInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: BUY_CORE_SPL_DISCRIMINATOR })
  );
}
