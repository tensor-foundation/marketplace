...
export const CLOSE_EXPIRED_LISTING_WNS_DISCRIMINATOR = new Uint8Array([
  222, 31, 183, 134, 230, 207, 7, 132,
]);

export function getCloseExpiredListingWnsDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    CLOSE_EXPIRED_LISTING_WNS_DISCRIMINATOR
  );
}
...
export function getCloseExpiredListingWnsInstructionDataEncoder(): Encoder<CloseExpiredListingWnsInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: CLOSE_EXPIRED_LISTING_WNS_DISCRIMINATOR,
    })
  );
}
