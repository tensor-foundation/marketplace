...
export const ASSET_LIST_STATE_DISCRIMINATOR = new Uint8Array([
  65, 195, 176, 188, 72, 18, 65, 77,
]);

export function getAssetListStateDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    ASSET_LIST_STATE_DISCRIMINATOR
  );
}
...
export function getAssetListStateEncoder(): Encoder<AssetListStateArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: ASSET_LIST_STATE_DISCRIMINATOR })
  );
}
