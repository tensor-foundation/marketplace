...
export const BID_TA_DISCRIMINATOR = new Uint8Array([
  186, 230, 110, 26, 235, 24, 211, 156,
]);

export function getBidTaDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(BID_TA_DISCRIMINATOR);
}
...
export function getBidTaEncoder(): Encoder<BidTaArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: BID_TA_DISCRIMINATOR })
  );
}
